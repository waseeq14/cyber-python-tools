...
def port_forwarding(value):
    if value == 1:
        proc = subprocess.Popen("echo 1 > /proc/sys/net/ipv4/ip_forward", shell=True, stdout=subprocess.PIPE)
    elif value == 0:
        proc = subprocess.Popen("echo 0 > /proc/sys/net/ipv4/ip_forward", shell=True, stdout=subprocess.PIPE)
